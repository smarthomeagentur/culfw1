...
void read_eeprom(char *in)
{
  ...
  if (in[1] == 'i')
  {
    ...
    {
      display_ee_ip4(EE_IP4_ADDR);
    }
    else if (in[2] == 'n')
    {
      display_ee_ip4(EE_IP4_NETMASK);
    }
    else if (in[2] == 'g')
    {
      display_ee_ip4(EE_IP4_GATEWAY);
    }
    else if (in[2] == 'N')
    {
      display_ee_ip4(EE_IP4_NTPSERVER);
    }
    else if (in[2] == 'o')
    {
      DH2(erb(EE_IP4_NTPOFFSET));
    }
    else if (in[2] == 'p')
    {
...
void write_eeprom(char *in)
{
  ...
  if (in[1] == 'i')
  {
    ...
    else if (in[2] == 'p')
    {
      d = 2;
      fromdec(in + 3, hb);
      addr = EE_IP4_TCPLINK_PORT;
    }
    else if (in[2] == 'N')
    {
      d = 4;
      fromip(in + 3, hb, 4);
      addr = EE_IP4_NTPSERVER;
    }
    else if (in[2] == 'o')
    {
      d = 1;
      fromhex(in + 3, hb, 1);
      addr = EE_IP4_NTPOFFSET;
#ifdef HAS_NTP
...
void eeprom_factory_reset(char *in)
{
